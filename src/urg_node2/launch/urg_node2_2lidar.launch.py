...
def generate_launch_description():
    ...
    # auto_start          : Transición automática al estado Active al iniciar (por defecto)true
    # node_name_1st       : Nombre del primer nodo (por defecto)"urg_node2_1st"
    # node_name_2nd       : Nombre del segundo nodo (por defecto)"urg_node2_2nd"
    # scan_topic_name_1st : Nombre del tópico (por defecto)"scan_1st" *No compatible con eco múltiple*
    # scan_topic_name_2nd : Nombre del tópico (por defecto)"scan_2nd" *No compatible con eco múltiple*
    # *Si usa eco múltiple, edite directamente las remappings en la sección de inicio del nodo arriba*
    # *Edite directamente el nombre del archivo de parámetros a cargar en la sección superior*
