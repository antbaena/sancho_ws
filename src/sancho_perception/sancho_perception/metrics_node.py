...
class RelayE2EMetricsNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("relay.input_topic", "/image_raw")
        self.declare_parameter("relay.output_topic", "/dlib/relay_image")
        self.declare_parameter("inference.header_topic", "/dlib/detections")
