...
def process_detections(keypoints_list, scores_list, keypoint_score_threshold, min_keypoints):
    """
...
def draw_skeleton(image, keypoints, scores, keypoint_score_threshold):
    ...
    for i, j in connections:
        if scores[i] > keypoint_score_threshold and scores[j] > keypoint_score_threshold:
            pt1 = keypoints[i]
            pt2 = keypoints[j]
