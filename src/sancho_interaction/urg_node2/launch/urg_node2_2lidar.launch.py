...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('node_name_1st', default_value='hokuyo_front'),
        DeclareLaunchArgument('scan_topic_name_1st', default_value='scan_front'),
        lifecycle_node_1st,
