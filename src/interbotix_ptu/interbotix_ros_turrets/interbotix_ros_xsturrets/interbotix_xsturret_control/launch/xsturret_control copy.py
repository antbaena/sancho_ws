...
def generate_launch_description():
    return LaunchDescription([
        ...
        #DeclareLaunchArgument('motor_configs', default_value="$(find interbotix_xsturret_control)/config/$(arg robot_model).yaml"),
        #DeclareLaunchArgument('mode_configs', default_value="$(find interbotix_xsturret_control)/config/modes.yaml"),
        DeclareLaunchArgument('load_configs', default_value="true"),
        DeclareLaunchArgument('use_sim', default_value="false"),

        # DeclareLaunchArgument('xs_sdk_type', default_value="xs_sdk", condition=UnlessCondition('use_sim')),
        # DeclareLaunchArgument('xs_sdk_type', default_value="xs_sdk_sim", condition=IfCondition('use_sim')),
